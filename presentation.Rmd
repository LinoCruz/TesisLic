...
background-image: url(https://i.ibb.co/VC8kPYQ/fondo.png)
background-size: 1217px
background-position: 100% 100%

---
class: middle, center, inverse
background-image: url(https://i.postimg.cc/Qx1XmyHc/logos-unidos.png)
...
Tesista: Bach. Lino Eduardo Cruz Díaz

Asesora: Dra. Lily de la Concepción Bautista Zúñiga
...
**6. Bibliografía Destacada**

---
background-image: url(https://i.ibb.co/Z21ST39/Intro.png)
...
---
background-image: url(https://i.ibb.co/dbXFrtM/method.png)
...
```
---
background-image: url(https://i.ibb.co/dJG4KX5/results.png)
...
---
background-image: url(https://i.ibb.co/2nhqV1S/conclusion.png)
...
background-image: url(https://i.ibb.co/sPs98gh/logos-final.png)
...
<br>
<br>
## "Nada en la ciencia tiene valor para la sociedad si no se comunica." 
### - Anne Rose (1952)
<br>
<br>
<br>
